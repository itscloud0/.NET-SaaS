...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:TextBox ID="txtDepart" runat="server" CssClass="input-field" MaxLength="3" Placeholder="From"></asp:TextBox>
            <asp:TextBox ID="txtArrival" runat="server" CssClass="input-field" MaxLength="3" Placeholder="To"></asp:TextBox>
